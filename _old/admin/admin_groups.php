...
EOD;
		...
		$(document).ready(function() {
			...
			$(' #form_search_for_group, #form_search_by_group ').hide();
...
?>
		...
		<div id="admin_form_container">
			...
			<form name="form_search_for_group" id="form_search_for_group" method="post" style="margin:25px 10px" 
				action="admin_groups.php">
				<h3 align="center"><br>Enter at least three letters of the Group's first name, last name, or both.<br>&nbsp;</h3>
				<label for="searchgroupname">Group Name : </label>
				<input type="text" name="searchgroupname" id="searchgroupname" class="name">
				<label for="searchcontact" style="margin-left:10px"> Point of Contact : </label>
				<input type="text" name="searchcontact" id="searchcontact" class="name">
				<ul>
			...
			<form name="form_search_by_group" id="form_search_by_group" method="post" style="margin:25px 10px" 
				...
				<?php
					if ($searchforgrp == 1) {
						...
						echo "						<input type='submit' name='submitSearchByGroup' id='submitSearchByGroup' class='button_text' value=' Edit ' " . $disabled . ">";
