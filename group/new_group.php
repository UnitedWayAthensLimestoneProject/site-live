...
<head>
	...
	<title>New Group Application - United Way of Athens/Limestone County</title>
    ...
    <script type='text/javascript'>
		$(document).ready(function() {
			...
			$('#form_register_new_group').validate( {
			...
			$('#form_register_new_group').submit(function()
				{
...
<body>
	<div id="wrapper">
		...
		<form id="form_register_new_group" class="appnitro"  method="POST"
			action="scripts/add_group.php">
		
		<div class="form_description">
			<h2>New Group Application Form</h2>
			<p>&#160;</p>
		</div>
		<li>
			<label class="description" for="type_of_work">The group is willing to volunteer for: (Please check all the apply.) 
				</label>
		...
		<ul>
			<li style="width:650px">
				<span>
					...
					<input name="group_name" id="tester" size="45" maxlength="60" type="text" 
						class="text required" />
				</span>
				<span style="margin-left:10px">
					<label class="description" for="contact">Point of Contact</label>
 					<input name="contact" size="26" maxlength="30" type="text" 
						class="text required" />
 				</span>
				<span>
					<label class="description" for="dob">Date Of Birth</label>
 					<input id="dob" name="dob" class="text required" size="30" />
				</span style="margin-left:10px">
  				<span class="clear">
					<label class="description" for="email">Email Address</label>
 					<input name="email" id="email" type="text" size="45" maxlength="40" 
						class="text email" /> 
				</span> 
 				<span style="margin-left:10px" id="phone">
					<label class="description" for="phone_num_header">Phone </label>
					<input name="phone_num" id="phone_num" size="20" maxlength="15" type="text" 
						class="text_phone" />
				</span>
				<span style="margin-left:10px" id="phone">
					<label class="description" for="cell_phone_header">Cell Phone </label>
					<input name="cell_phone" id="cell_phone" size="20" maxlength="15" type="text" 
						class="text_phone" />
				</span>
			</li>
			<li>
				<span>
					...
					<input name="street_address" size="87" maxlength="30" type="text"
						class="text" />
			...
			<li>
				<label class="description" for="location">We are willing to volunteer in: 
					</label>
				<span class="left" style="width:200px">
					 ...
					 <tr>
					 	<td>
							<span>
								...
								<input name="emer_email" id="email" class="text email" 
		...
		<ul style="margin-left:75px">
			<li>
				...
				Experience that is not listed above? </label>
				<span>
		...
		<ul>
			...
			<li class="buttons" id="buttons">
			    <input type="hidden" name="form_id" value="submit_register_new_group" />			    
