...
<!-- Main Content Starts Below-->								
				...
				<p>
				<!-- Staff member's role -->
				Volunteer Administration Manager</br>
				<!-- Email address with link to open a new outgoing email -->
				E-mail: <a href="mailto:leighandrews@unitedwayalc.com?" title="leighandrews@unitedwayalc.com">leighandrews@unitedwayalc.com</a><br>
				<!-- Phone number with link to call from a smartphone  -->
