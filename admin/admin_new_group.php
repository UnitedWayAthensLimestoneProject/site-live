<?php 
	...
	$(document).ready(function() {
		...
		$('#form_register_group').submit(function()
				{
...
EOD;
	...
	page_start("Disaster Group Registration Form", $javascript, "addgroup", $_REQUEST['success_message'], $error_message);
	admin_menu();
...
?>
    ...
    <div id="admin_form_container">
		...
		<form id="form_register_group" class="appnitro"  method="POST"
			action="scripts/add_group.php">
		
		<div class="form_description">
			<h2>Disaster Group Registration Form
				<div style="float:right">
					<input type="button" id="print_btn" value="Print">
				</div>
			</h2>
			<p class="clear">Note: Verification of the volunteering group's credentials and 
		...
		<ul>
			...
			<li style="width:650px">
				<span>
					...
					<input name="group_name" size="45" maxlength="60" type="text" 
						class="text required" />
				</span>
				<span style="margin-left:10px">
 				...
 				<span style="margin-left:10px">
					<label class="description" for="dob">Date Of Birth</label>
 					<input id="dob" name="dob" class="text required" size="15" />
				</span>
				<span style="margin-left:10px" id="ssn">
					<label class="description" for="ssn">Last 4 Digits of POC's SSN (####)</label>
			...
			<li>
				<span>
					...
					<input name="street_address" size="80" maxlength="30" type="text"
						class="text" />
		...
		<ul>
			...
			<li class="buttons">
			    <input type="hidden" name="form_id" value="submit_register_group" />
