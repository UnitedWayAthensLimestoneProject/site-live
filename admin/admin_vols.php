...
EOD;
    ...
    $('#editvoltable').w2grid({ 
        ...
        searches: [                
            ...
            { field: 'active', caption: 'Active', type: 'list', options: { items: [ 'ACTIVE', 'INACTIVE' ] } },
        ...
        columns: [                
            ...
            { field: 'active_color', caption: 'Active', size: '100px', sortable: true, attr: 'align=center' },
		...
		/* **ASU2016**  End added code 6/20/2016   */
				   "		   FROM volunteers " .
				   "		  WHERE " . $where .
				   "	   ORDER BY active DESC, first_name, " .
				   "	 		    last_name";
		...
		/* **ASU2016**  End added code 6/20/2016   */
			...
			if($row['active']==1)
			{
				...
				$javascript .= "', active: 'INACTIVE', active_color: '<font color=red>INACTIVE</font>' },";
			}
			$javascript .= "
			";
		}
