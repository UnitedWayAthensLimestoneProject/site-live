...
?>
    ...
    <div id="admin_form_container">
		<form id="disaster_relief_form" class="appnitro"  method="POST"
			action="scripts/add_disaster.php">
	...
	<li>
		<span>
			...
			<input name="pre_add_st1" size ="80" maxlength ="30" type ="text" class ="text" />
			<label for ="pre_add_st1"> Street Address (line 1)</label>
		</span>
		<span class ="clear">
			<input name= "pre_add_st2" size="80" maxlength ="30" type ="text" class ="text"/>
	...
	<li>
		<span>
			...
			<input name="post_add_st1" size ="80" maxlength ="30" type ="text" class ="text required" />
			<label for ="post_add_st1"> Street Address (line 1)</label>
		</span>
		<span class ="clear">
			<input name= "post_add_st2" size="80" maxlength ="30" type ="text" class ="text "/>
