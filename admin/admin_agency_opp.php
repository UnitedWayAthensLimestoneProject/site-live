...
EOD;
	...
	page_start("Agency Opportunity Request Form", $javascript, "adminOpportunities", $_REQUEST['success_message'], $error_message);
...
?>
		...
		<div id="admin_form_container">
			<div class="form_description" align="center">
				<h2>Add Agency Opportunity</h2>
				<p>Gives Administrators the ability to add agency opportunities.
			</div>
