...
?>
    ...
    <div id="admin_form_container">
		...
		<div class="form_description">
			<h2>Volunteer Registration Form
		...
		<ul>
			...
			<li style="width:650px">
				...
				<span style="margin-left:10px" id="phone">
					...
					<input name="cell_phone" id="cell_phone" size="15" maxlength="15" type="text" 
						class="text_phone" />
				</span>
			</li>
			<li>
				...
				<span class="clear">
					<input name="street_address2" size="80" maxlength="30" type="text"
						class="text" />
