...
EOD;
		...
		$(document).ready(function() {
			...
			$(' #search_by_agency ').prop('checked', true);
			$(' #search_by_skills, #search_by_volunteer ').attr('disabled', true);
			$(' #form_search_by_skills, #form_search_by_skills_grp, #form_search_for_agency_requests, #form_search_by_agency, #form_search_for_volunteer, #form_search_by_volunteer, #form_view_volunteer_skills, #form_search_results, #form_search_by_group, #form_search_for_group ').hide();
...
EOD;
		...
		$(document).ready(function() {
			...
			$(' #form_search_by_skills, #form_search_by_skills_grp, #form_search_for_agency_requests, #form_search_by_agency_requests, #form_search_by_agency, #form_skiils_by_opportunity, #form_search_for_volunteer, #form_view_volunteer_skills, #form_search_results, #form_search_results_grp, #form_search_by_group, #form_search_for_group ').hide();
...
EOD;
		...
		$(document).ready(function() {
			...
			$(' #search_by_volunteer ').prop('checked', true);
			$(' #search_by_skills, #search_by_agency ').attr('disabled', true);
			$(' #form_search_by_skills, #form_search_by_skills_grp, #form_search_for_agency_requests, #form_search_by_agency_requests, #form_search_by_agency, #form_skiils_by_opportunity, #form_search_for_volunteer, #form_search_by_volunteer, #form_search_results, #form_search_by_group, #form_search_for_group ').hide();
...
EOD;
		...
		$(document).ready(function() {
			...
			$(' #search_by_group ').prop('checked', true);
			$(' #search_by_skills, #search_by_agency ').attr('disabled', true);
			$(' #form_search_by_skills, #form_search_by_skills_grp, #form_search_for_agency_requests, #form_search_by_agency_requests, #form_search_by_agency, #form_skiils_by_opportunity, #form_search_for_volunteer, #form_search_by_volunteer, #form_search_results, #form_search_for_group ').hide();
...
EOD;
		...
		$(document).ready(function() {
			...
			$(' #form_search_by_skills, #form_search_for_agency_requests, #form_search_by_agency_requests, #form_search_by_agency, #form_search_for_volunteer, #form_search_by_volunteer, #form_view_volunteer_skills, #form_search_results, #form_search_results_grp, #form_search_by_group, #form_search_for_group, #form_search_by_skills_grp ').hide();
...
?>
		...
		<div id="form_container">
			...
			<form name="form_search_by_skills_grp" id="form_search_by_skills_grp" method="post" class="appnitro" style="margin:25px 10px" action="skills_search.php">
				<ul><li class="section_break"></li></ul>
				<center>
					<table id="skillstable" align="center">
						<tr valign="top">
			...
			<form name="form_search_results" id="form_search_results" method="post" style="margin:25px -45px" action="skills_search.php">
				<?php
					if ($searchbyskills == 1) {
						$searchbyskills = 0;
						$list = "";
			...
			<form name="form_search_results_grp" id="form_search_results_grp" method="post" style="margin:25px -45px" action="skills_search.php">
				<?php
