<?php
	...
	$processType = mysql_real_escape_string($_REQUEST['submitAdminGrp']);
	...
	if ($processType == 'Update') {
		...
		$msg = "The group has been successfully updated.";
		header("Location: ../admin_groups.php?success_message=" . $msg);
