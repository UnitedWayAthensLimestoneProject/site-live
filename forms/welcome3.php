	...
	<div id="wrapper">
		...
		<div id="menu" align="center">
  		...
  		<div id="form_container">
			...
			<form id="form_code_of_conduct" method="POST" action="donationsform_consentform.php">
				...
				<table id="codeofconducttable">
					<tr>
						<td><p>Thank you for donating items to the United Way of Athens-Limestone County.</p></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
					<tr>
						<td><p>Once your donation form is processed, we will contact you to set up a meeting.<br>However, if you have any questions or concerns feel free to contact <b>Leigh Andrews at 256-233-2323.</b> Thank you!</p></td>
					</tr>
