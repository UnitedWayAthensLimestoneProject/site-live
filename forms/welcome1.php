	...
	<div id="wrapper">
		...
		<div id="menu" align="center">
  		...
  		<div id="form_container">
			...
			<form id="form_code_of_conduct" method="POST" action="disasterform_consentform.php">
				...
				<table id="codeofconducttable">
					<tr>
						<td><p>The United Way of Athens-Limestone County will assist you as soon as possible.</p></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
