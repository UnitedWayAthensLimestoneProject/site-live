...
<!-- Main Content Starts Below-->
				...
				<p>Submit your group application with the United Way of Athens-Limestone County:<br />
				<a class="button" href="./forms/group_safety_brief.php" target="_blank">Group Application Form </a></p>
